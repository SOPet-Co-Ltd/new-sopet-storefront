...
export type Bag5IconProps = Omit<InlineIconProps, 'children'>;

export function Bag5Icon({ color = 'currentColor', ...props }: Bag5IconProps) {
  return (
    <InlineIcon viewBox="0 0 24 24" color={color} {...props}>
