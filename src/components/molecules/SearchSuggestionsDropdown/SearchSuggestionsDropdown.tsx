...
export function SearchSuggestionsDropdown({
  ...
  return (
    <div
      className="absolute left-0 right-0 top-[calc(100%+8px)] z-50 max-h-[min(80vh,480px)] overflow-y-auto rounded-lg border border-sop-neutral-gray-400 bg-white shadow-lg"
