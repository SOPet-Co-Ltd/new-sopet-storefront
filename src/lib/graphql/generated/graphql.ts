...
export type ApprovedCategoriesQuery = { approvedCategories: Array<{ id: string, name: string, slug: string }> };
...
export type OrdersQuery = { orders: Array<{ id: string, orderNumber: string, status: string, subtotal: number, shippingFee: number, discountAmount: number, total: number, paymentMethod: string, items: Array<{ id: string, storeId: string, productName: string, unitPrice: number, quantity: number, subtotal: number, fulfillmentStatus: string }> }> };
...
export type PlatformBannersQuery = { platformBanners: Array<{ id: string, title: string, imageUrl: string, linkUrl: string | null, sortOrder: number, isActive: boolean, startsAt: string | null, endsAt: string | null }> };
